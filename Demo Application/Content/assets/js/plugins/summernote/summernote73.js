...
(function (factory) {
  ...
  var buttonGroup = renderer.create('<div class="note-btn-group btn-group note-table">');
  ...
  $.extend($.summernote.lang, {
    'en-US': {
      ...
      removeTableBorder: {
          link: 'Remove table border',
          //insert: 'Remove border',
  ...
  var Table = function () {
    ...
    this.createTable = function (colCount, rowCount, options) {
      ...
      trHTML = trs.join('');
      var $table = $('<table width="100%">' + trHTML + '</table>');
  ...
  var Editor = function (context) {
    ...
    this.unlink = function () {
      ...
      //Remove table border
    this.removeTableBorder = function () {
        if ($(".table").hasClass("removeTableBorder")) {
            $(".removeTableBorder").removeClass("table-bordered");
            $(".removeTableBorder").addClass("borderless");
            $(".table").removeClass("removeTableBorder");
        }
        else {
            ShowMessage("error", "Please select table.");
        }
    };
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
      ...
      context.memo('button.removeTableBorder', function () {
          return ui.button({
              contents: ui.icon(options.icons.removeTableBorder),
              tooltip: lang.removeTableBorder.link,
              click: context.createInvokeHandler('editor.removeTableBorder')
          }).render();
      });
      ...
      context.memo('button.ulink', function () {
          return ui.button({
