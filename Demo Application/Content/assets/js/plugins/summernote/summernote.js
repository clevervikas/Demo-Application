...
(function (factory) {
  ...
  var Editor = function () {
     ...
     * @param {Object} options
     */
      // Custome changes made in editor for blocking tab, if you want to revert this chanages  uncomment following line code {2325 to 2330}
    this.tab = function ($editable, options) {debugger
      //var rng = range.create();
