var page_actions = function () {
    ...
    $(".lockscreen-box .user_signin").on("click", function () {        
        $(".sign-in").show();
        $(this).remove();
        //$(".user").hide().find("img").attr("src",'../Content/images/no-image.jpg');
        $(".user").show();
        return false;
    });
    /* END LOCK SCREEN */
...
function page_content_onresize() {
    ...
    if (vpW > 1024) {
        ...
        $(".page-sidebar .xn-openable ul").removeClass("navigation-scroll");
    }
...
function panel_refresh(panel, action, callback) {
    if (!panel.hasClass("panel-refreshing")) {
        panel.append('<div class="panel-refresh-layer"><img src="/Content/assets/img/loaders/default.gif"/></div>');
...
function x_navigation_minimize(action) {
    ...
    if (action == 'open') {
        //ShowMessage("success", "open");
        $(".page-sidebar.scroll").mCustomScrollbar("update");
        $(".page-sidebar .x-navigation").removeClass("x-navigation-minimized");

        $(".page-container").removeClass("page-container-wide");        
        $(".x-navigation-minimize").find(".fa").removeClass("fa-indent").addClass("fa-dedent");       
        $(".page-sidebar .xn-openable ul").removeClass("navigation-scroll customScroll");
    }

    if (action == 'close') {
        //ShowMessage("success", "close");
        ...
        $(".page-sidebar .xn-openable ul").addClass("navigation-scroll customScroll");
    }
...
function x_navigation() {
    ...
    // This is click event for navigation click        
    $(".x-navigation li").click(function (event) {        
        if (!$('.page-container').hasClass('page-navigation-toggled') || $(this).hasClass("sign-Off")) {
